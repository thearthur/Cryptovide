...
(deftest test-encrypt-file
  ...
  (let [file1 (str input-file-name "1")
    ...
    (assert-file-contains file1 '(1 1 119 108 106 35 117 122 108 103 112 35
                                   102 119 114 123 115 35 106 116 123 36 111
                                   120 113 117 104 104 37 114 122 106 117 36
                                   121 107 105 37 111 101 127 124 36 105
                                   114 107))
    (assert-file-contains file2 '(2 1 126 114 117 42 123 133 115 109 123 42 108
    ...
    (assert-file-contains file3 '(3 1 137 122 134 53 131 150 126 117 140 53 116
